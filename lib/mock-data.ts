...
export function buildMockOutfitImage(styleTitle: string, index: number) {
  ...
  return (
    "data:image/svg+xml;base64," +
    Buffer.from(
      `<svg xmlns="http://www.w3.org/2000/svg" width="1024" height="1120" viewBox="0 0 1024 1120"><defs><linearGradient id="bg" x1="0" x2="1" y1="0" y2="1"><stop offset="0" stop-color="${background}"/><stop offset="1" stop-color="#fffaf2"/></linearGradient><filter id="shadow"><feDropShadow dx="0" dy="14" stdDeviation="16" flood-color="#18242b" flood-opacity="0.16"/></filter></defs><rect width="1024" height="1120" fill="url(#bg)"/><rect x="72" y="34" width="880" height="1048" rx="46" fill="#fffaf2" stroke="#ccbda8" stroke-width="4"/><ellipse cx="512" cy="1016" rx="232" ry="32" fill="#18242b" opacity="0.14"/><g filter="url(#shadow)"><circle cx="512" cy="150" r="82" fill="${skin}"/><path d="M448 128c24-64 108-66 140-9 9 18 9 43-1 64-30-27-70-38-123-35-7 0-14-8-16-20z" fill="#202a30"/><rect x="466" y="224" width="92" height="78" rx="32" fill="${skin}"/><path d="M350 296h324c54 78 72 205 50 384H300c-22-179-4-306 50-384z" fill="${jacket}"/><path d="M446 296h132l-32 384H446z" fill="${shirt}"/><path d="M350 320c-82 72-128 164-138 276l100 28c18-98 56-172 112-224z" fill="${jacket}"/><path d="M674 320c82 72 128 164 138 276l-100 28c-18-98-56-172-112-224z" fill="${jacket}"/>${hasPattern ? `<g opacity="0.8" fill="${shirt}"><circle cx="394" cy="402" r="22"/><circle cx="632" cy="428" r="20"/><rect x="378" y="514" width="268" height="26" rx="13"/><text x="512" y="598" text-anchor="middle" font-family="Arial" font-size="82" font-weight="700" fill="${shirt}">S</text></g>` : `<path d="M350 568h374" stroke="${shirt}" stroke-width="24" opacity="0.45"/>`}<path d="M364 680h164l-26 320H368z" fill="${pants}"/><path d="M548 680h162l-2 320H574z" fill="${pants}"/><path d="M346 994h182v52H296c-5-31 12-48 50-52z" fill="#24282d"/><path d="M552 994h182c38 4 55 21 50 52H552z" fill="#24282d"/></g></svg>`,
    ).toString("base64")
  );
}
